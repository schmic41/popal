...
{
  emxInit_real_T1(sp, &pStruct->xyz, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->weights, 1, srcLocation, doPush);
}
...
/* End of code generation (int_xc_emxutil.c) */
